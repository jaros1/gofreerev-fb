  ...
  test "reject_proposal_c" do
    ...
    assert_notifications(:method => __method__,
                         :notifications => [
                             ...
                             #    note that the unread new_proposal_giver_other_1_v1 notification to sandra
                             #    is changed to an unread new_comment_giver_other_1_v1 notification
                             #    see Comment.send_notification rule 4a
                             {:to_user_id => u1_sandra.user_id,
                              :noti_key => 'new_comment_giver_other_1_v1',
                              :no_users => 1,
                              :usernames => ["Karen S"]
      ...
      # note that new proposal notification to u1/sandra is changed to a new comment notification
      c2.accepted_yn = 'N'
      assert c2.save!
    end # assert_notifications
